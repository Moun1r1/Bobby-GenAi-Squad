...
leaders responsible for enforcement by contacting the maintainer [@Moun1r1](https://github.com/Moun1r1)
through GitHub (a [private security advisory](https://github.com/Moun1r1/Bobby-Self-Organizing-Agent-Squad/security/advisories/new)
may be used for a private channel). All complaints will be reviewed and investigated promptly and fairly.
